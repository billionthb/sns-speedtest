...
cd C:\Users\jsnider\AppData\Local\Programs\Python\Python36
...
set /p rep="How long is the test interval, in minutes: "
...
schtasks /create /RU SYSTEM /SC ONSTART /TN Speedtest /TR C:/AUTORUN/speedtest.bat /RI %rep% /RL HIGHEST /F